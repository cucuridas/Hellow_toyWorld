...
<html>
    ...
    <button type="button" onclick="location.href='https://search.naver.com/search.naver?query=<% out.print(cpage); %>&where=news&ie=utf8&sm=nws_hty'"><span></span><h4>네이버 뉴스에서 검색하기</h4></button>
                <%
       				 rs.close();
       				 stm.close();
				}
